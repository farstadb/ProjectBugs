	...
	<div id="header">
		<div id= "imageContainer">
			...
			<i class="fa fa-caret-down"></i>
						...
						<a href = "http://localhost:8080/projectbugs/functions/testManagement.php" class="dropbtn"target="_blank"> About Test data Management </a>
						<!-- About Automation popup, new tab (using target="_blank") -->
						<a href = "http://localhost:8080/projectbugs/functions/generatingLink.php"target="_blank"> Test-Generation </a>
						<!-- Selenium popup, new tab (using target="_blank") -->
						<a href = "http://localhost:8080/projectbugs/functions/populatingLink.php"target="_blank"> Test-Population </a>
			...
			<div class="dropdown">
					<button class = "dropbtn"><a href = "http://localhost:8080/projectbugs/functions/performance.php"target="_blank">Performance</a>
						<i class="fa fa-caret-down"></i>
					</button>
						<div class="dropdown-content">
