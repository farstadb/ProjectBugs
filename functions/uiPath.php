...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="#uiPath">UiPath</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <br></br>
      <h1 class="w3-text-teal"id ="Headline">UiPath</h1>
      <p>
      </p>
    </div>
    ...
    <div class="w3-twothird w3-container">
      ...
      <p>Introduction to UiPath.. 
    </div>

  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-teal" id ="uiPath">UiPath</h2>
      <p>what it is</p>
    </div>
