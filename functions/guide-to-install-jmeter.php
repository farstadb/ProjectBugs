...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5" id="mySidebar">
  ...
  <br><a class="w3-bar-item w3-button w3-hover-black" href="http://localhost:8080/projectbugs/functions/jmeter.php">JMeter & Introduction & Uses</a>
  ...
  href="http://localhost:8080/projectbugs/functions/jmeter-element-reference.php">JMeter Elements:</a>
...
<p id="slidetag">&nbsp;</p><script> jQuery( document ).ready(function() { jQuery(".jh-image-popup-colorbox").colorbox(); });</script>	</div>
	...
	<li class="previous">
		<a class="hasTooltip" title="" aria-label="Previous article: What is JMeter? Introduction &amp; Uses" href="http://localhost:8080/projectbugs/functions/jmeter.php" rel="prev" data-original-title="What is JMeter? Introduction &amp; Uses">
			<span class="icon-chevron-left" aria-hidden="true"></span> 
			<span aria-hidden="true">Prev</span></a>
	</li>
			
	<li class="next">
		<a class="hasTooltip" title="" aria-label="Next article: JMeter Elements: Thread Group, Samplers, Listeners, Configuration" href="http://localhost:8080/projectbugs/functions/jmeter-element-reference.html" rel="next" data-original-title="JMeter Elements: Thread Group, Samplers, Listeners, Configuration">
