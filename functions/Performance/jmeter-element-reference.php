...
<p>&nbsp; 
	...
	<li class="previous">
		<a class="hasTooltip" title="" aria-label="Previous article: How to Download &amp; Install Apache JMeter in easy steps" href="http://localhost:8080/projectbugs/functions/Performance/guide-to-install-jmeter.php" rel="prev" data-original-title="How to Download &amp; Install Apache JMeter in easy steps">
			<span class="icon-chevron-left" aria-hidden="true"></span> <span aria-hidden="true">Prev</span>		</a>
	</li>
	
	<li class="next">
		<a class="hasTooltip" title="" aria-label="Next article: JMeter GUI: Test Plan &amp; Workbench" href="/hands-on-with-jmeter-gui.html" rel="next" data-original-title="JMeter GUI: Test Plan &amp; Workbench">
